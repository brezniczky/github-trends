...
These are considered the presentation in this analysis and thus not the 'active ingredient'. While it is included in AWS, difficult to tell to what extent it was useful to be in that way.
However, the means presentation are an important factor of analysis, and their merits will be re-evaluated.
