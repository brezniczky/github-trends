...
```{r echo=FALSE}
counts <- rbind("C++" = dl_data_table$C.., Java = dl_data_table$Java, 
                MatLab = dl_data_table$MatLab, Python = dl_data_table$Python)
colnames(counts) <- spark_table$Year
...
```{r echo=FALSE}
counts <- rbind(Python = big_data_table$Python, Java = big_data_table$Java, 
                R = big_data_table$R, Scala = big_data_table$Scala)
colnames(counts) <- spark_table$Year
