...
At the minute, it seems, if you only choose one programming language for analytics (however overly idealized that may be), or about to choose your first one, it is Python for the win.
...
There are lots of thigns to work out in such an exploding ecosystem, and in the best case you're part of the happenings.
