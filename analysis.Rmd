...
```{r "k7", echo=FALSE, fig.width=10, cache=TRUE}
double.plot(github.results$`Data Science`, SO.results$`Data Science`, "Data Science")
```

### Sub-keyword: "Science"

```{r "sk1", echo=FALSE, fig.width=10, cache=TRUE}
smooth.plot(github.results$`Science`, "Science")
```

### Sub-keyword: "Data"

```{r "sk2", echo=FALSE, fig.width=10, cache=TRUE}
...
```{r "k8", echo=FALSE, fig.width=10, cache=TRUE}
double.plot(github.results$Mining, SO.results$Mining, "Mining")
```

## Keyword #9: "Visualization"

```{r "k9", echo=FALSE, fig.width=10, cache=TRUE}
double.plot(github.results$Visualization, SO.results$Visualization, "Visualization")
```

## Keyword #10: "Chart"

```{r "k10", echo=FALSE, fig.width=10, cache=TRUE}
double.plot(github.results$Chart, SO.results$Chart, "Chart")
```

## +1: "Kaggle"

```{r "+1", echo=FALSE, fig.width=10, cache=TRUE}
double.plot(github.results$`Kaggle`, SO.results$`Kaggle`, "Kaggle")
```

## +2: "Coursera"

```{r "+2", echo=FALSE, fig.width=10, cache=TRUE}
