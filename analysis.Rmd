...
To gather the data, a GitHub API client script was used to obtain weekly statistics, then a Daniel k-filter was applied to get values smoothed over 53-week windows to get visually comprehensible charts.
...
all.cols = c("blue", "darkgreen", "yellow", "red")
...
smooth.plot = function(raw.values, main) {
  ...
  xs = as.Date(c("2008-01-15", "2009-01-15", "2010-01-15", "2011-01-15", "2012-01-15", "2013-01-15", "2014-01-15", "2015-01-15", "2016-01-15"))
