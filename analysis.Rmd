...
The results make it clearer than yearly data what happens with R and Python in the 'Analysis' section.
...
JavaWScript and HTML have notoriously been omitted from these statistics. 
These are considered the presentation in this analysis and thus not the 'active ingredient'.
However, means presentation are an important factor of analysis, and their merits will be re-evaluated.
Another problematic aspect is that repositories are normally multi-lingual, thus "intersection sets" will need to be checked on and accounted for.
