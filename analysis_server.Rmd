...
The method was to search for keywords using a GitHub client script over weekly intervals, starting from 2008-01-01, and then using a 22 radius Daniel k-filter plot some comprehensibly smooth charts and compensate for likely seasonality effects.
